...
void imu_interrupt_handler(void *callback_arg, cyhal_timer_event_t event)
{
    ...
    {
#ifdef CY_IMU_SPI
            data.accel.y / (float)0x1000,
            data.accel.x / (float)0x1000,
            data.accel.z / (float)0x1000,
#endif
#ifdef CY_IMU_BMI270
            data.sensor_data.acc.x/ (float)0x1000,
            data.sensor_data.acc.y/ (float)0x1000,
            data.sensor_data.acc.z/ (float)0x1000,
#endif
#ifdef CY_IMU_I2C
            data.accel.x / (float)0x1000,
            data.accel.y / (float)0x1000,
